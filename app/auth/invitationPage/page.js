...
export default function regsiter() {
    ...
    return (
        ...
        <main className="flex relative">
            <div className="w-[600px] h-[100vh] relative max-lg:hidden"> {/* desktop size */}
                <img src="/images/wenearBanner.jpg" alt="" className="w-[100%] h-[100%] " />
                <img src="/images/wenearLogo.png" alt="" className="w-[250px] h-[150px] -rotate-[20deg] absolute top-[35%] left-[20%] " />
            </div>

            <div className="flex items-center lg:hidden absolute top-[20px] left-[20px]"> {/* other sizes */}
                <img src="/images/wenearLogo.png" alt="" className="w-[35px] h-[27px] " />
                <p className="font-bold text-[25px] text-gray-700 ">ENEAR</p>
            </div>
            ...
            <div className="lg:relative rounded-lg w-full h-[100vh] flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex gap-5 absolute bottom-[15px] left-[20px] ">
                    <p className="text-[15px] text-gray-500 cursor-pointer">Privacy Policy</p>
                    <p className="text-[15px] text-gray-500 cursor-pointer">Terms & conditions</p>
                </div>
            </div>
        </main>
        </>

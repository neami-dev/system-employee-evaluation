...
const IntegrationPage = () => {
    ...
    return (
        <>
        {Clickup == null && Github == null ? <Loading /> :
        <div className="min-h-screen bg-blue-50 flex flex-col items-center justify-center p-4 lg:p-10">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 lg:space-y-0 lg:flex-row lg:space-x-8">
                ...
                route.push(
                    ...
                    className={`${Clickup ? "bg-green-500 hover:bg-green-700": "bg-blue-500 hover:bg-blue-700"} text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300 ease-in-out flex items-center space-x-2`}>
                ...
                <button onClick={() => route.push(
                    ...
                    className={`${Github ? "bg-green-500 hover:bg-green-700": "bg-blue-500 hover:bg-blue-700"} text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300 ease-in-out flex items-center space-x-2`}>
